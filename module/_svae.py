...
from scSVAE.distributions import VonMisesFisher, HypersphericalUniform
...
from scSVAE.nn import EncoderSVAE

torch.backends.cudnn.benchmark = True


# VAE model
class SVAE(BaseModuleClass):
    """
    Spherical variational auto-encoder model.
    ...
    def loss(
        ...
        q_z = VonMisesFisher(qz_m, qz_v)
        p_z = HypersphericalUniform(self.n_latent - 1)

        kl_divergence_z = kl(q_z, p_z).mean()
